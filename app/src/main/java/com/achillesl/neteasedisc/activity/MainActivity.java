...
import static com.achillesl.neteasedisc.widget.DiscView.DURATION_NEEDLE_ANIAMTOR;
import static com.achillesl.neteasedisc.widget.DiscView.IPlayInfo;
import static com.achillesl.neteasedisc.widget.DiscView.MusicChangedStatus;
...
public class MainActivity extends AppCompatActivity implements IPlayInfo, View
    ...
    private void initMusicDatas() {
        MusicData musicData1 = new MusicData(R.raw.huan_ting, R.raw.ic_music1, "幻听", "许嵩");
        MusicData musicData2 = new MusicData(R.raw.you_he_bu_ke, R.raw.ic_music2, "有何不可", "许嵩");
        MusicData musicData3 = new MusicData(R.raw.jing_hong_yi_mian, R.raw.ic_music3, "惊鸿一面", "许嵩");
