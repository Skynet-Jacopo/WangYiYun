...
public class BackgourndAnimationRelativeLayout extends RelativeLayout {
    ...
    private void initLayerDrawable() {
        Drawable backgroundDrawable = getContext().getResources().getDrawable(R.drawable
                .ic_blackground);
...
//                        INDEX_FOREGROUND));
                layerDrawable.setDrawableByLayerId(INDEX_BACKGROUND, layerDrawable.getDrawable(
                        INDEX_FOREGROUND));
            }
...
//        layerDrawable.setDrawable(INDEX_FOREGROUND, drawable);
        layerDrawable.setDrawableByLayerId(INDEX_FOREGROUND, drawable);
